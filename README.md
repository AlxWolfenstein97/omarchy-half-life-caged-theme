# C.A.G.E.D. — Omarchy theme

Remember that short and sweet Half-Life 1 mod exclusively featuring combat
...
of *Half-Life: C.A.G.E.D.* — **not affiliated with Future Games Select, Cayle
George, or Valve** (see [Credits](#credits--legal-ish) below).

No Omarchy / Windows / other-desktop **C.A.G.E.D.** pack turned up. Closest
Half-Life desktop hits are generic HL themes (Internet Archive Win9x packs,
DeviantArt HL2 Rainmeter) — wrong game, logo-heavy, not port-worthy. Built
from Steam store / library art and HUD-less in-mod screenshots the same way
as
...
Black Mesa hazard-orange + blueprint cyan. This pack is the *prison* —
amber CRT glow, rust concrete, Judgment-Bot red. Same universe, different
sentence.

<p align="center">
  <img src="logo.png" alt="Half-Life: C.A.G.E.D. wordmark used for unlock / README" width="520" />
</p>
...
```bash
omarchy theme install https://github.com/AlxWolfenstein97/omarchy-half-life-caged-theme.git
# optional — About + screensaver ASCII for this theme (skippable; see Branding)
cp ~/.config/omarchy/themes/half-life-caged/about.txt ~/.config/omarchy/branding/about.txt
cp ~/.config/omarchy/themes/half-life-caged/screensaver.txt ~/.config/omarchy/branding/screensaver.txt
```
...
```bash
git clone https://github.com/AlxWolfenstein97/omarchy-half-life-caged-theme.git ~/.config/omarchy/themes/half-life-caged
omarchy theme set "Half-Life Caged"
...
- Visual inspiration and reference art from **Future Games Select** / **Cayle
  George**’s *Half-Life: C.A.G.E.D.* branding and marketing (Steam library
  logo / hero, official key art, HUD-less Steam store screenshots). Soundtrack
  credit to **Garrett “Lazerhawk” Hays**. **Not affiliated with, endorsed by,
  or sponsored by Future Games Select, Cayle George, Valve, or Lazerhawk.**
  Just public pixels arranged into an Omarchy theme — no money, no official
  product.
- Steam store shots used for holding cell, flooded corridor, Global Control,
  sewage pump, Cell Block D/E, D Block North, thermonuclear countermeasures,
  north dock, and Judgment-Bot 9000 were checked for HUD and title overlays
  before shipping — logo-bearing menu composites / combat HUD frames were
  dropped on purpose.
- If Future Games Select, Cayle George, or Valve hates this existing, they can
  say so and I’ll deal with the repo accordingly.

## License

Do whatever you want with this theme pack unless Future Games Select, Cayle
George, Valve Corporation (or the law) says otherwise. Fork it, recolor it,
ship it in a rice. No warranty — it’s wallpaper and hex codes.
